                ...
                <div class="col-lg-8">
                  <div class="p-5">
                    <div class="d-flex justify-content-between align-items-center mb-5">
                      ...
                      <h6 class="mb-0 text-muted">({{session()->has('cart') ? count(session()->get('cart')):0}}) items</h6>
                    </div>
                    <hr class="my-4">
                    @if($carts)
                    ...
                    <div class="row mb-4 d-flex justify-content-between align-items-center">
                      <div class="col-md-2 col-lg-2 col-xl-2">
                        <img
                          {{-- src="{{url('/uploads/uploads/product/',$data->image)}}" --}}
                      ...
                      <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                        ...
                        <input id="form1" min="0" name="quantity" value="{{$data['product_qty']}}" type="number"
                ...
                <div class="col-lg-4 bg-grey">
                  <div class="p-5">
                    ...
                    <div class="d-flex justify-content-between mb-4">
                      <h5 class="text-uppercase">items ({{session()->has('cart') ? count(session()->get('cart')):0}})</h5>
                      <h5></h5>
                    </div>
