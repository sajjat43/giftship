                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mt-2 mb-2">
                                        ...
                                        <div class="col-6">
                                            <div class="text-small"><span class="text-danger">0.7%</span> higher
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="text-dark">
                                                ...
                                                <div class="d-flex pb-3 pt-3 border-bottom justify-content-between">
                                                    ...
                                                    <div class="font-weight-bold mr-sm-4">
                                                        <div>Deposit has updated to Paid </div>
                                                        <div class="text-muted font-weight-normal mt-1">1 Days Ago
                                                        </div>
                                                    </div>
                                                    <div>
                                        ...
                                        <table class="table table-header-bg">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-success"><i
                                                                class="icon-arrow-up mr-2"></i>+60%</div>
                                                    </td>
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-sm-10">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-success"><i
                                                                class="icon-arrow-up mr-2"></i>+40%</div>
                                                    </td>
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-sm-10">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pb-0">
                                                        <div class="text-success"><i
                                                                class="icon-arrow-up mr-2"></i>+80%</div>
                                                    </td>
                                                    <td class="pb-0">
                                                        <div class="row">
                                                            <div class="col-sm-10">
